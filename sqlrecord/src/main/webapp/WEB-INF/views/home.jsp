...
<<<<<<< HEAD
	<style>
	  ...
	  .section_serch_item_textBox {
	  	width: 100%;
	  	font-size: 12px;
	  	text-align: center;
	  	color: black;
	  	font-weight: 700;
	  	height: 24px; /* 동일한 높이를 설정합니다 */
        line-height: 24px; /* 줄 높이를 동일하게 설정합니다 */
	  }
...
>>>>>>> d6f0bbc3b580a40a9a60c1808b406a2708bce94a
  ...
  <div id="section_slide">
   ...
   <h2 style="padding: 5px;"><a href="#" style="color: black;">최신 상품 ></a></h2>
 ...
 <div id="section_slide">
   <div>
   <h2 style="padding: 5px; color: black;"><a href="#" style="color: black;">당신을 위한 추천 ></a></h2>
